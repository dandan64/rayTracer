...
public:
    dielectric(double  refraction) : refraction_index(refraction){}

    bool scatter(const ray& r_in, const hit_record
    & rec, color& attenuation, ray& scattered) const override{
